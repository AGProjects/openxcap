...
import sys,urllib.request,urllib.error,urllib.parse,re,string
...
class SAX_xmldc(saxlib.Parser,saxlib.Locator):
    ...
    def parse(self, systemId):
        try:
            ...
            infile=urllib.request.urlopen(systemId)
